...
{% autoescape off %}
{% localize off %}
{% block vars %}var geodjango = {}; var bounds = new GLatLngBounds(); {% for icon in icons %}
...
{% block load %}{{ js_module }}.{{ dom_id }}_load = function(){
  if (GBrowserIsCompatible()) {
    ...
    /*bounds.extend (new GLatLng ({{ center.1 }}, {{ center.0 }}));*/
    {% block controls %}{{ js_module }}.{{ dom_id }}.setUIToDefault();{% endblock %}
    {% if calc_zoom %}bounds = new GLatLngBounds(); var tmp_bounds = new GLatLngBounds();{% endif %}
